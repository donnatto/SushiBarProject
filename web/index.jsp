...
<!DOCTYPE html>
<% String mensaje = (String) request.getSession().getAttribute("respuesta");%>
<html>
            ...
            <form action="usuariocontroller.do?accion=login" method="POST">
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="clave" id="contraseña" placeholder="Ingresa tu contraseña" required>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 pr-lg-5">
            ...
            <!--Modal Mensaje-->
            <div class="modal fade" tabindex="-1" id="mensaje" role="dialog" >
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                </div>
